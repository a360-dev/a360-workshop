...
function App() {
    useEffect(() => {
        console.log("%c--- A360 CORE V7.3 DEPLOYED ---", "background: #00ff00; color: #000; font-size: 20px; font-weight: bold; padding: 10px;");
        console.log("A360 Platform Version: 1.0.8-WS-V7.3");
